...
Infine, la funzione seguente esegue la ricerca del punteggio massimo per ogni pixel. La funzione \verb|MAX| a riga 8 calcola il massimo tra due valori.
...
__global__ void fill_holes_step(i32 *web, i32 *tmp, int width)
{
    ...
    if (tmp[IDX(x, y, width)] == 0) {
        web[IDX(x, y, width)] = (tmp[IDX(x+1, y,   width)]
                              + tmp[IDX(x,   y+1, width)]
                              + tmp[IDX(x-1, y,   width)]
